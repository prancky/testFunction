...
<path d="M7.65 18L18.85 29.2L16 32L0 16L16 0L18.85 2.8L7.65 14H32V18H7.65Z" fill="#1E3A8A"/>
</svg>
`;
...
const SvgImage_i5o3j = ({ width, height, color, style }: SvgImageProps) => {
...
export default SvgImage_i5o3j;
export { SvgImage_i5o3j };
